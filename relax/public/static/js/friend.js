...
function appendFriend(myId, friendId, portrait, name) {
    ...
    var node = '<li class="list-group-item">' +
        ...
        '<a href=' + detail + '><img class="friend_list_icon" src="/relax/public/static/images/my/friend/detail.svg"></a>' +
        '</div>' +
        '<div class="col-lg-1">' +
...
function cancelFork(myId, forkId, link) {
    ...
    var success = function (data) {
        ...
        $('#fork_count').text(parseInt($('#fork_count').text())-1);
...
function releaseComment(btn, blogId, userId) {
    ...
    var success = function (data) {
        ...
        var colon = ':';
        var path = '/relax/public/static/images/my/friend/delete2.png';
...
function showFriends() {
    $('#fan_link').removeClass('active');
    $('#friend_link').addClass('active');
    $('#fan_list').hide();
    $('#friend_list').show();
    $('#compare_btn').show();
}
 ...
 */
function showFans() {
    $('#friend_link').removeClass('active');
    $('#fan_link').addClass('active');
    $('#friend_list').hide();
    $('#fan_list').show();
    $('#compare_btn').hide();
}
