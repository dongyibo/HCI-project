 ...
 * 注销按钮
 */
function logoutIn(img) {
    $(img).attr('src','/relax/public/static/images/admin/nav/logout1.png');
}

function logoutOut(img) {
    $(img).attr('src','/relax/public/static/images/admin/nav/logout.png');
}