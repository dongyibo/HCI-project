    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2">
                ...
                <a href="javascript:void(0)"><img id="img_face" class="img-circle"
                                                  @if($user->portrait==null)src="{{asset('static/images/my/temp.png')}}"
                                                  @else src="{{asset('uploads/avatar/'.$user->portrait)}}"
                                                  @endif alt="点击更换头像"></a>
            ...
            <div class="col-lg-10 intro-text">
                ...
                <div class="row">
                    ...
                    <h6 style="margin-top: 18px;color: wheat;margin-left: -20px" class="col-lg-1">@if($user->level>3)运动达人@else社区新人@endif</h6>
                    <div id="prompt_activity" class="col-lg-2 col-lg-offset-2" style="margin-top: 15px">
                ...
                <div id="progress" onmouseover="showActivity({{$user->level}},{{$user->activity}});"
                     class="progress progress-striped active" style="width:1000px ;background-color: #fdfdc9">
