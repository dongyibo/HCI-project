    ...
    <div class="col-lg-12">
        ...
        @endif
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <input type="text" name="username" class="input-lg form-control" id="name" placeholder="请输入您要搜索用户的用户名，或用户名中含有的文字">
    </div>
        </form>
        <div class="col-lg-2">
            <span>
                <input style="margin-top: -5px" onclick="searchUsers();" onmouseover="searchIn(this);" onmouseout="searchOut(this);" type="image" src="{{asset('static/images/my/friend/search.png')}}">
            </span>
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 search_list_avatar_div">
                                        <a href="{{url('user/'.$u->id)}}"><span class="search_name">{{$u->username}}</span></a>
                                    </div>
                                    <div class="col-lg-1 search_list_avatar_div">
                                        <button onclick="forkUser({{$user->id}},{{$u->id}});" type="button" class="btn btn-info">关注</button>
                ...
                <div class="row">
                    <div class="col-lg-1 col-lg-offset-11 close_panel_div">
                        ...
                        <button type="button" class="close" data-dismiss="alert"
                                aria-hidden="true" onclick="closeSearch();">
                            &times;
                        </button>
                        <script type="text/javascript">
