...
@section('content')
    ...
    <div id="sport_alert_div" class="row">
        <div class="col-lg-12">
            <div id="sport_alert" class="alert alert-success" style="display: none;">
            </div>
        </div>
    </div>
    @if(isset($burn_heat))
        <script>
            $('#sport_alert').show();
            $('#sport_alert').text('恭喜你燃烧了 {{$burn_heat}} 大卡热量!');
            $('#sport_alert').fadeOut(4000);
        </script>
    @endif
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" id="form_upload_div_row">
                                    ...
                                    <div class="col-lg-12 form_upload_div">
                                        <form name="sport_form" class="form-horizontal" method="post"
                                              action="{{url('my/sport/'.$user->id)}}">{{--{{url('User/save')}}--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-1" style="width: 13%">
                                                    <select id="start_hour" name="start_hour" class="form-control">
                                                        @for($i=0;$i<24;$i++)
                                                            @if($i<10)
                                                                <option {{old('start_hour')=="0$i"?'selected':''}}>
                                                                    0{{$i}}</option>
                                                            @else
                                                ...
                                                <div class="col-lg-1 time_modify" style="width: 13%">
                                                    <select id="start_minute" name="start_minute" class="form-control">
                                                        @for($i=0;$i<60;$i++)
                                                            @if($i<10)
                                                                <option {{old('start_minute')=="0$i"?'selected':''}}>
                                                                    0{{$i}}</option>
                                                            @else
                                                ...
                                                <div class="col-lg-1 time_modify" style="width: 13%">
                                                    <select id="start_second" name="start_second" class="form-control">
                                                        @for($i=0;$i<60;$i++)
                                                            @if($i<10)
                                                                <option {{old('start_second')=="0$i"?'selected':''}}>
                                                                    0{{$i}}</option>
                                                            @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-1" style="width: 13%">
                                                    <select id="end_hour" name="end_hour" class="form-control">
                                                        @for($i=0;$i<24;$i++)
                                                            ...
                                                            @elseif($i<10)
                                                                <option {{old('end_hour')=="0$i"?'selected':''}}>
                                                                    0{{$i}}</option>
                                                            @else
                                                ...
                                                <div class="col-lg-1 time_modify" style="width: 13%">
                                                    <select id="end_minute" name="end_minute" class="form-control">
                                                        @for($i=0;$i<60;$i++)
                                                            @if($i<10)
                                                                <option {{old('end_minute')=="0$i"?'selected':''}}>
                                                                    0{{$i}}</option>
                                                            @else
                                                ...
                                                <div class="col-lg-1 time_modify" style="width: 13%">
                                                    <select id="end_second" name="end_second" class="form-control">
                                                        @for($i=0;$i<60;$i++)
                                                            @if($i<10)
                                                                <option {{old('end_second')=="0$i"?'selected':''}}>
                                                                    0{{$i}}</option>
                                                            @else
                                            ...
                                            <div class="form-group distance_div">
                                                ...
                                                <div class="col-lg-5">
                                                    <input value="{{old('distance')?old('distance'):''}}" type="text"
                                                           name="distance" class="form-control input_data" id="distance"
                                                           placeholder="请输入您运动的距离（m）">
                                                </div>
                                                <div class="col-lg-4">
                                            ...
                                            <div class="form-group" id="check_btn_div">
                                                <div class="col-lg-offset-5 col-lg-2">
                                                    <button type="button" onclick="uploadSportData();" id="submit_btn"
