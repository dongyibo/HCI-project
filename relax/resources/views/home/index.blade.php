        ...
        <div class="container">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                    <li><a id="login_link" href="javascript:void(0)" class="link btn btn-link">用户登录</a></li>
                    <li><a id="register_link" href="javascript:void(0)" class="link btn btn-link">用户注册</a></li>
                    <li><a id="back_link" href="javascript:void(0)" class="link btn btn-link">返回主页</a></li>
                </ul>
            </div>
        </div>
    </nav>
