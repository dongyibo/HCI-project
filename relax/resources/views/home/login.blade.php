<section id="login">
    <div class="container">
        ...
        <div id="login_alert_div" class="row">
                            ...
                            @else
                                <form role="form" action="{{url('home/adminLogin')}}" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="User[username]" placeholder="请输入您的用户名"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="login-auto" class="control-label col-lg-4"
                                               style="margin-left: -20px">自动登录（一周内）</label>
                                    </div>
                                    <br>
                                    <button type="submit" class="btn">登 录</button>
                                    <a href="javascript:void(0)" onclick="showRegister();">
                                        <h6 class="control-label col-lg-4" style="margin-top: 5px">还没账号？请<span
                                                    style="color: red">注册</span></h6>
                                    </a>
                                    <script>
