...
Route::group(['middleware'=>['web']],function(){
    ...
    //活动页面
    Route::any('my/activity/{tag?}/{search?}',['uses'=>'EventController@activity']);
    //朋友圈页面
    ...
    //展示活动报名人数
    Route::any('my/showActivityPeople/{id}',['uses'=>'EventController@showActivityPeople']);
    //比较
    Route::any('compare/{id}',['uses'=>'EventController@compare']);
});
...
Route::group(['prefix' => 'ajax'],function (){
    ...
    //比较
    Route::get('compareDetail/{id}',['uses'=>'EventController@compareDetail']);
    //活动比较
    Route::get('compareActivity/{id}',['uses'=>'EventController@compareActivity']);
    //比较活跃度
    Route::get('compareLevel/{id}',['uses'=>'EventController@compareLevel']);
    //用户等级分布
    Route::get('userLevels',['uses'=>'EventController@userLevels']);
//    //刷新热门消息
